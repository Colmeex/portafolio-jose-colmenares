...
import Home from "../../images/travel/Home.png";
import Landing from "../../images/travel/Landing.png";
import Activity from "../../images/travel/CreaActividad.png";
		...
		<div className="flex flex-col mt-[2rem] items-center min-h-screen font-sans">
			...
			>
				...
				<p className="mt-2 text-slate-300 ">
					This is a web project that uses the Countries API to allow users to
					search for countries by name, continent, and population, and also to
					add activities for each of them in the different seasons of the year
					(winter, spring, summer, and fall).
				</p>
				<p className="mt-4 text-slate-300 ">
					With this application, users can explore detailed information about
					each country. The goal of this project is to provide a useful and
					efficient tool for those interested in learning more about the
					different countries of the world and planning activities for their
					travels.
				</p>
			</motion.div>
			<motion.div
